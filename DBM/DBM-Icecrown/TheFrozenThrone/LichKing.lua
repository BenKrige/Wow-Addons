...
local ttsInfestSoon = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\infestSoon.mp3", "TTS Infest callout", mod:IsHealer())
...
function mod:NextPhase()
	...
	elseif phase == 2 then
		...
		timerSoulreaperCD:Start(40) -- before:32
		ttsSoulreaperSoon:Cancel()
